...
//			while(i<10) {
//				if(i==0) {
//					// break: 가장 가까운 반복문을 종료하는 것
//					break loop; // loop 라는 이름의 반복문을 종료
//				}
//			}
//		}
//		
...
//		// 1 ~ 100까지의 랜덤숫자를 생성해서, 10번 시도하여 맞히는 프로그램을 구현하시오.
//		// 1번째 시도입니다.
//		// while문 / for문
//		// 번호를 입력했을 때 입력한 수보다 큰 수 / 작은 수 입니다.
//		// 정답입니다.
//		// 정답: 7
